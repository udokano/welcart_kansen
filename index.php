           ...
           <section class="p-chart-bottom-area bg-section-gray">
                ...
                <div class="p-use-chart-list-top p-chart-bottom-top c-bg-purple">
                    ...
                    <div class="p-use-chart-list-top__inner p-chart-bottom-top__inner">
                            ...
                            <p class="p-chart-bottom-top__desc">検査結果は<span class="c-yellow02">ウェブ</span>にて行います。<br>検体到着<span class="c-yellow02">1～2日後</span>を目安にログインし<br class="u-sp">確認を行ってください。<!-- <span class="c-yellow02">電話、ウェブ上にて通知など</span><br>ご希望の方法で結果をお知らせいたします。Web案内時に専任スタッフへお伝えください。 --></p>
