  ...
  <img src="<?php echo get_template_directory_uri(); ?>/img/front/fv_menu01_sp.jpg?6dbddba84c650683" alt="児童・医療従事者の無償検査PCR無償検査を通じて子供達を守り、医療従事者を支えております。" class="u-sp">
                ...
                <li class="p-fv-menu__list-small">
                    <div class="p-fv-menu__list-img-row02">
                        <a href="#link-inspection-company" >
...
<section class="p-cost p-cost--top">
    <div class="l-inner">
        ...
        <p class="p-cost__desc c-blue">検査キット、郵送、採取案内、検査キット回収、<br class="u-sp">検査実施<!-- (2回) -->を含むお値段です。</p>
...
<div class="p-free-inspection --row-right p-bg-light-blue" id="link-free-inspection01">
        <div class="l-inner">
            <div class="p-free-inspection__box-wrap">
                <div class="p-free-inspection__box  --row-left-text">
                    ...
                    <div class="p-free-inspection__desc-area  --desc-area-left">
                            <p class="p-free-inspection__desc">当院では、教育機関等における児童の無償検査を行っております。</p>
                                ...
                                <img src="<?php echo get_template_directory_uri(); ?>/img/front/inspection_thumb01_sp.jpg?6dbddba84c650683" alt="教育機関における児童の無償検査" class="u-sp --desc-area-left__sp-thumb">
                    </div>
                    <!-- ./p-free-inspection__desc-area -->

                    <div class="p-inspection-list-area c-bdc-yellow">
                                <p class="p-inspection-list-area__ttl c-yellow">検査実施をご利用いただいた教育機関一覧</p>
                                <?php if (have_rows('lists01',73)): ?>
                                    <ul class="p-inspection-list">
                                        <?php while (have_rows('lists01',73)) : the_row(); ?>
                                             <li class="p-inspection-list__item">   <?php the_sub_field('lists_texts',73); ?></li>
                                        <?php endwhile; ?>
                                    </ul>
                                <?php else: ?>
                                <?php endif; ?>
                ...
                <div class="p-free-inspection__thumb  --row-right--img u-pc">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/front/inspection_thumb01.jpg?6dbddba84c650683" alt="教育機関における児童の無償検査" class="">
                </div>
...
<div class="p-free-inspection --row-left" id="link-free-inspection02">
        <div class="l-inner">
            <div class="p-free-inspection__box-wrap --box-wrap--nth2">
                <div class="p-free-inspection__box  --row-right-text">
                    ...
                    <div class="p-free-inspection__desc-area  --desc-area-right">
                            <p class="p-free-inspection__desc">医療機関でのクラスターの発生状況も踏まえ、医療従事者の負担、疲労、それに伴う免疫機能の低下による新たな健康被害の拡大も危惧されております。<br>医療崩壊を防ぐためにも、医療従事者を感染から守り、広めてしまわない事が大切だと考えております。<br>そこで私達は、PCR無償検査を通じて医療従事者を支え、国を支える取り組みを行っております。</p>
                                <img src="<?php echo get_template_directory_uri(); ?>/img/front/inspection_thumb02_sp.jpg?6dbddba84c650683" alt="教育機関における児童の無償検査" class="u-sp --desc-area-right__sp-thumb">
                    </div>
                    <!-- ./p-free-inspection__desc-area -->

                    <div class="p-inspection-list-area c-bdc-light-blue">
                                <p class="p-inspection-list-area__ttl c-lught-blue">検査実施をご利用いただいた医療機関一覧</p>
                ...
                <div class="p-free-inspection__thumb  --row-left--img u-pc">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/front/inspection_thumb02.jpg?6dbddba84c650683" alt="教育機関における児童の無償検査" class="">
                </div>
                <!-- ./p-free-inspection__thumb -->
            </div>
            <!-- ./p-free-inspection__box-wrap -->
    ...
    <ul class="p-personal-inspection-action">
            ...
            <li class="p-personal-inspection-action__item">
                ...
                <a href="#link-use" class="p-personal-inspection-action__link">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/img/front/personal_inspection_thumb01.jpg?6dbddba84c650683" alt="" class="p-personal-inspection-action__pc-thumb u-pc-display">
             ...
             <li class="p-personal-inspection-action__item">
                ...
                <a href="<?php echo home_url( '/' ); ?>item-list" class="p-personal-inspection-action__link">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/img/front/personal_inspection_thumb03.jpg?6dbddba84c650683" alt="" class="p-personal-inspection-action__pc-thumb u-pc-display">
...
<section class="p-pcr-kit" id="link-kit">
    <div class="l-inner">
        <h2 class="c-ttl-under-center p-pcr-kit__ttl c-blue">検体採取キットについて</h2>
        <div class="p-pcr-kit-row">
            <div class="p-pcr-item-box">
                <div class="p-pcr-item-box__thumb">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/front/Inspection_Item.jpg?07235555555" alt="PCR検体採取キット">
                </div>
                    ...
                    <dd class="p-pcr-item-box__desc-text">
                        <ul class="p-pcr-item-box__list">
                            ...
                            <li class="p-pcr-item-box__list-item">・唾液採取用漏斗</li>
                                <li class="p-pcr-item-box__list-item">・検体回収用封筒</li>
                        </ul>
                    </dd>
                </dl>
            </div>
            ...
            <div class="p-pcr-right-contents">
                    <p class="p-pcr-right-contents__desc">キット購入後は、同封された手順説明書を確認しながら「Web案内予約」を行ってください。<br>「Web案内」では、唾液採取のご案内や段取りのご説明などを行います。<br>その際、ビデオ通話はクリニクスを<!--  -->介して行いますので、インストール済みのスマートフォン、もしくはカメラがついているPCをご用意の上、ご利用ください。</p>
...
<section class="p-use-flow bg-section-gray" id="link-use">
    <div class="l-inner js-tab-wrap">
        ...
        <p class="u-tc u-fw600 p-use-flow__note">お住まいのエリアによってご利用方法が異なります。</p>


        <ul class="p-chart-btn">
                <li class="p-chart-btn__item js-tab-btn">東京、名古屋、大阪、福岡にお住いの方</li>
                <li class="p-chart-btn__item js-tab-btn">それ以外のエリアにお住いの方</li>
        </ul>
        <div class="js-tab-contents p-use-chart-wrap">
                ...
                <ul class="p-use-chart__left p-use-chart-list">
                    ...
                    <li class="p-use-chart-list-item p-chert-left-row02 p-pos-left c-bdc-water-blue">
                     ...
                     <li class="p-use-chart-list-item p-chert-left-row03 p-pos-left c-bdc-water-blue">
                           <div class="p-use-chart-list-item__inner p-inner-left ">
                        <p class="p-use-chart-list-item__text u-tl">検体採取キットが届きましたら、同封されている案内を見ながらオンライン案内のご予約を行ってください。</p>
                        <a href="<?php echo home_url( '/' ); ?>clinics" class="c-btn-circle-arw p-use-chart-list-item__btn" target="_blank">ご予約はこちら</a>
                          </div>
                    </li>
                    <li class="p-use-chart-list-item  p-chert-left-row04 p-pos-left c-bdc-water-blue">
                          <div class="p-use-chart-list-item__inner p-item-pd-pt02 p-inner-left p-inner-left--db-color p-inner-row03">
                        <div class="p-use-chart-list-item__row">
                                    <div class="p-use-chart-list-item__thumb --spspsp">
                                        <img src="<?php echo get_template_directory_uri(); ?>/img/front/flow_left_thumb01.png?1455522" alt="thumb">
                                    </div>

                                    <p class="p-use-chart-list-item__l-text">スタッフの案内に従って、唾液を採取し、回収用のケースに保管しておくようしてください。</p>
                                      </div>
                        </div>
                    </li>

                     <li class="p-use-chart-list-item p-chert-left-row06 p-pos-left c-bdc-water-blue">
                          <div class="p-use-chart-list-item__inner p-inner-left  p-inner-row04">
                         <p class="p-use-chart-list-item__text u-mb0 u-tc">
検体回収業者へ回収のご依頼を<br class="u-pc">行ってください。<a href="<?php echo home_url('/')?>tel/transport.html" class="c-pink p-recov-num" target="_blank">TEL 03-3456-3671 </a>※日・祝日は電話受付を休止しております。</p>
                           </div>
                    </li>

                    <li class="p-use-chart-list-item p-chert-left-row05 p-pos-left c-bdc-water-blue">
                          <div class="p-use-chart-list-item__inner p-inner-left  p-inner-row04">
                         <p class="p-use-chart-list-item__text u-mb0 --text-left">何らかの自覚症状がある場合や、感染者との濃厚接触歴がある方は自宅待機となります。</p>
                           </div>
                    </li>
                </ul>
              ...
              <ul class="p-use-chart__left p-use-chart-list">
                    ...
                    <li class="p-use-chart-list-item  p-chert-right-row02 p-pos-right c-bdc-pink">
                        ...
                        <div class="p-use-chart-list-item__row u-sp-ff-reverse">
                                    ...
                                    <div class="p-use-chart-list-item__thumb --thumb-w-small">
                                        <img src="<?php echo get_template_directory_uri(); ?>/img/front/flow_right_thumb01.png?145522" alt="thumb">
                                    </div>
                    ...
                    <li class="p-use-chart-list-item  p-chert-right-row04 p-pos-right c-bdc-pink">
                     ...
                     <li class="p-use-chart-list-item p-chert-right-row05 p-pos-right c-bdc-pink">
                           <div class="p-use-chart-list-item__inner p-inner-right ">
                        <p class="p-use-chart-list-item__text u-mb0">院内にて患者様の唾液のPCR検査を行います。<br>混雑状況にもよりますが、検体がクリニック届いてから、おおよそ1～2日を目安に結果をお知らせいたします。</p>
                          </div>
                    </li>
                </ul> </div>
            </div>
           ...
           <section class="p-chart-bottom-area bg-section-gray">
                ...
                <div class="p-use-chart-list-top p-chart-bottom-top c-bg-purple">
                    ...
                    <div class="p-use-chart-list-top__inner p-chart-bottom-top__inner">
                            ...
                            <a href="https://souki-kai.or.jp/rslt/" class="c-btn-arw-sq p-use-chart-list-top__btn" target="_blank">検査結果通知サイト<span class="c-btn-arw-sq__right-box p-use-chart-list-top__btn-right"><i class="c-btn-arw-sq__arw p-use-chart-list-top__btn-arw"></i></span></a>
                    </div>
                ...
                <ul class="p-chart-bottom-list">
                    ...
                    <li class="p-chart-bottom-item p-chart-bottom-item--left c-bg-orange">
                        ...
                        <p class="p-chart-bottom-item__radius c-orange02">陰性</p>
                    ...
                    <li class="p-chart-bottom-item p-chart-bottom-item--right c-bg-deep-gray">
                        ...
                        <p class="p-chart-bottom-item__radius c-deep-gray">陽性</p>
    ...
    <div class="l-access-inner">
        <div class="p-clinic-info-row">
            ...
            <div class="p-clinic-info-right">
                ...
                <p class="p-clinic-info-right__guide">FAX : 06-4708-8105<br>受付 10:00～20:00  不定休</p>
...
<div class="l-inner l--sp-width100">
    <div class="p-online-box">
        <h2 class="p-online-box__ttl"><span class="">クリニクス</span>でオンライン診療のご案内</h2>
        <p class="p-online-box__desc">来院不要、検査キットはご郵送。クリニクス上で問診を行っております。</p>
        <a href="<?php echo home_url( '/' ); ?>comming" class="c-btn-circle-arw p-online-box__btn">ご利用案内</a>
    </div>
    <!-- ./box -->
</div>
<!-- ./l-inner -->
