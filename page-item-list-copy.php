  ...
  <ul class="p-items">
          ...
          <!--   <li class="p-items__contents">
            ...
            <li class="p-items__contents">
                ...
                <div class="p-items__row">
                        <div class="p-items__thumb">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/item-list/item08.jpg?07225555" alt="陰性証明書発行">
                        </div>
            ...
            <li class="p-items__contents">
                ...
                <div class="p-items__row">
                        <div class="p-items__thumb">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/item-list/item09.jpg?07225555" alt="陰性証明書発行">
                        </div>
