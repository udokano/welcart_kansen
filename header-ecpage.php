...
商品詳細ページ、ECページ内はBOGOの条件分岐ができないので、
ブラウザーの言語設定でソースを出し分け
...
<header class="l-header p-header p-header--top" id="js-header">
    ...
    <div class="p-header__inner p-header__inner--top">
        ...
        <a href="<?php echo home_url( '/' ); ?>item-list" class="p-header__sp-gray-btn u-sp-display" >
        <span class="p-header__sp-gray-btn-text">Specimen collection <br> kit</span></a>
        ...
        <div class="p-header__right p-header__right--top u-pc-display">
              ...
              <!--   <li class="p-top-btns__item c-btn-gray">
                ...
                <li class="p-top-btns__item p-top-btns__item--other c-btn-gray">
                  <a href="<?php echo home_url( '/' ); ?>item-list" class="p-top-btns__link c-btn-gray__link">
                  Purchase of Specimen Collection Kit
                  </a>
                </li>
              </ul>
              ...
              <div class="p-header-tels u-pc-display">
                ...
                <p class="p-header__number p-header__number--top u-font-futura"><span class="p-header__number-sq">Individuals</span><span class="p-header__number-num">0120-088-120</span></p>
              </a>

                <a href="<?php echo home_url( '/' ); ?>tel/campany.html" class="p-header__tel p-header__tel--top u-pc-display">
                <p class="p-header__number p-header__number--top u-font-futura"><span class="p-header__number-sq">Companies / Organizations</span><span class="p-header__number-num p-header__number-num--campany">06-4708-8082</span></p>
              </a>

                <p class="p-header__time p-header__time--top">Reception hours：9:00~19:00<!--<br><span class="u-text-under-line">※日・祝日は電話受付を休止しております。</span>--></p>
              </div>
        </div>
        <!-- ./p-header__right -->
    ...
    <!-- ./p-header__inner -->
          <div class="p-global-nav --global-top --global-other" id="js-global-nav">

                <ul class="p-global-nav__list --global-top-list --global-other">
                  ...
                  <li class="p-global-nav__item --global-top-item">
                    <a href="<?php echo home_url( '/' ); ?>#link-kit" class="p-global-nav__link --global-top-link js-sp-clink-menu-close">
                        Specimen <br class="u-sp">collection kit
                    </a>
                  </li>
                 <!--   <li class="p-global-nav__item --global-top-item">
                ...
                <div class="p-global-nav__sp-btn-wrap u-sp-display">
                  <a href="<?php echo home_url( '/' ); ?>item-list" class="p-global-nav__sp-btn">Purchase of Specimen Collection Kit</a>
                  <a href="<?php echo home_url( '/' ); ?>contact" class="p-global-nav__sp-btn" target="_blank">Enquiries</a>
                </div>
                <!-- ./p-global-nav__sp-btn-wrap -->

                <div class="u-sp-display">
                   <p class="p-header__guide p-header__guide--other">Contact us by phone</p>

                  <a href="<?php echo home_url( '/' ); ?>tel/kansenshou.html" class="p-header__tel u-sp-display" target="_blank">

                        <p class="p-header__number p-header__number--other"><span class="p-header__number-sq p-header__number-sq--other">Individuals</span>
                   ...
                   <a href="<?php echo home_url( '/' ); ?>tel/campany.html" class="p-header__tel u-sp-display" target="_blank">
                        ...
                        <p class="p-header__number p-header__number--other"><span class="p-header__number-sq p-header__number-sq--other">Companies / Organizations</span>
                        <span class="p-header__number-num">06-4708-8082</span></p>

                  </a>

                   <p class="p-header__time">Reception hours 9:00~19:00<!--<br><span class="u-text-under-line">※日・祝日は電話受付を休止しております。</span>--></p>
                </div>
...
<header class="l-header p-header p-header--top" id="js-header">
    ...
    <div class="p-header__inner p-header__inner--top">
        ...
        <a href="<?php echo home_url( '/' ); ?>item-list" class="p-header__sp-gray-btn u-sp-display" >
        <span class="p-header__sp-gray-btn-text">购买采<br>样套件</span></a>
        ...
        <div class="p-header__right p-header__right--top u-pc-display">
              ...
              <div class="p-header-tels u-pc-display">
                          ...
                          <a href="<?php echo home_url( '/' ); ?>tel/kansenshou.html" class="p-header__tel p-header__tel--top u-pc-display">
                <p class="p-header__number p-header__number--top u-font-futura"><span class="p-header__number-sq">个人</span><span class="p-header__number-num">0120-088-120</span></p>
              </a>

                <a href="<?php echo home_url( '/' ); ?>tel/campany.html" class="p-header__tel p-header__tel--top u-pc-display">
                <p class="p-header__number p-header__number--top u-font-futura"><span class="p-header__number-sq">企业及团体</span><span class="p-header__number-num p-header__number-num--campany">06-4708-8082</span></p>
              </a>

                <p class="p-header__time p-header__time--top">挂号时间：9:00~19:00<!--<br><span class="u-text-under-line">※日・祝日は電話受付を休止しております。</span>--></p>
              </div>
        </div>
        <!-- ./p-header__right -->
...
<header class="l-header p-header p-header--top" id="js-header">
    ...
    <div class="p-header__inner p-header__inner--top">
        ...
        <a href="<?php echo home_url( '/' ); ?>item-list" class="p-header__sp-gray-btn u-sp-display" >
        <span class="p-header__sp-gray-btn-text">検査キットの<br>ご購入</span></a>
    ...
    <!-- ./p-header__inner -->
          <div class="p-global-nav --global-top" id="js-global-nav">
                ...
                <div class="p-global-nav__sp-btn-wrap u-sp-display">
                  ...
                  <a href="<?php echo home_url( '/' ); ?>contact" class="p-global-nav__sp-btn" target="_blank">お問合せ</a>
                </div>
                <!-- ./p-global-nav__sp-btn-wrap -->
