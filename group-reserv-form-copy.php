    ...
    <!--   <p class="p-ccc-note">企業・団体様に限り日本どこからでもご購入・ご利用が可能です。</p><p class="p-ccc-note__sub">現在、個人でのご購入・ご利用の場合のみ、購入地域制限(東京、名古屋、大阪、福岡)をさせていただいております。</p> -->
        ...
        <p class="p-cost__desc c-blue">検査キット、郵送、採取案内、検査実施を含むお値段です。</p>
         ...
         <dl class="p-cost-price u-mb10">
                ...
                <dd class="p-cost-price__text"><span class="p-cost-price__text-main">13,200</span><span class="p-cost-price__text-sub">円(税込)</span></dd>
        </dl>
         <dl class="p-cost-price  u-mb10">
                <dt class="p-cost-price__name">PCR検査 <br class="u-sp">5回</dt>
                <dd class="p-cost-price__text"><span class="p-cost-price__text-main">1回あたり 10,560</span><span class="p-cost-price__text-sub">円(税込)</span>
                <br class="u-sp"><!-- <span class="aaaaa">＊1個あたり</span> --></dd>
        </dl>

         <dl class="p-cost-price  u-mb10">
                <dt class="p-cost-price__name">PCR検査 <br class="u-sp">10回</dt>
                <dd class="p-cost-price__text"><span class="p-cost-price__text-main">1回あたり 9,768</span><span class="p-cost-price__text-sub">円(税込)</span>
                <br class="u-sp"><!-- <span class="aaaaa">＊1個あたり</span> --></dd>
        </dl>
